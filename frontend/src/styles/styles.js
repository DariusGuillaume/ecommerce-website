const styles  = { 
    ...
    active_indicator: "absolute bottom-[-27%] left-0 h-[3px] w-full bg-[#f5a623]",
    button : "w-[150px] bg-black h-[50px] my-3 flex items-center justify-center rounded-xl cursor-painter",
    cart_button : "px-[20px] h-[38px] rounded-[20px] bg-[#f5a623] flex items-center justify-center cursor-pointer",
    cart_button_text : "text-[#fff] text-[15px] font-[500] font-Roboto",
    input: "w-full border p-1 rounded-[5px]", 
    activeStatus: "w-[10px] h-[10px] rounded-full absolute top-0 right-1 bg-[#f5a623]",
